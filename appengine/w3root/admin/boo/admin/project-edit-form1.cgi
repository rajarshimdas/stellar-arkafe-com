    ...
    <tr style="background: RGB(240,240,240); height: 40px;">
        ...
        <td width="10%">
            ...
            if ($sysShowDeletedProj > 0) {
                echo '<a class="button" href="' . BASE_URL . 'admin/sysadmin.cgi?a=Project%20Edit&showDel=0">Hide</a>';
            } else {
                echo '<a class="button" href="' . BASE_URL . 'admin/sysadmin.cgi?a=Project%20Edit&showDel=1">Show</a>';
            }
            ?>
