<table width="100%" cellspacing="4px" cellpadding="4px">
    <form action="concert-mis.cgi" method="GET">
        <input type="hidden" name="a" value="teammateView">
        <tr>
            <td>
                <table width="100%" cellspacing="" cellpadding="2" border="0">
                    <tr>
                        ...
                        <td width="80px">
                            <input name="fdt2" type="date" value="<?= $finStartDate ?>" max="<?= date('Y-m-d') ?>">
                        </td>
                        <td width="25px" align="right">
                            To:
                        </td>
                        <td width="80px">
                            <input name="tdt2" type="date" value="<?= date('Y-m-d') ?>" max="<?= date('Y-m-d') ?>">
                        </td>
                        <td width="50px">
