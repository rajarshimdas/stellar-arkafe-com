...
<table>
    ...
    <form
        action="PrintDWGList-BW.cgi"
        method="POST"
        target="windowName"
        onsubmit="window.open('',this.target,'dialog,modal,scrollbars=yes,resizable=no,width=900,height=700,left=300,top=100');"
        >
                        ...
                        <td width="170px" align="undefined" valign="bottom">
                            <select name="dc" style="width:100%">
                                <option>-- All/Select --</option>
                                    ...
                                    // $sql = "SELECT disciplinecode, discipline FROM discipline ORDER BY id";
                                    $sql = "SELECT 
                                                disciplinecode, 
                                                discipline 
                                            FROM 
