...
Epoch.prototype.calConfig = function () //PRIVATE: initialize calendar variables
{
	...
	this.rangeYearLower = 2015; // Customized - Rajarshi
	this.rangeYearUpper = 2030; // Customized - Rajarshi
	this.minDate = new Date(2005,0,1);
	this.maxDate = new Date(2037,0,1);
	this.startDay = 1; // the day the week will 'start' on: 0(Sun) to 6(Sat) - Rajarshi
	this.showWeeks = true; //whether the week numbers will be shown - Rajarshi
...
{    
	...
	var clearSelected = document.createElement('input');
        // Rajarshi - Disabled the Clear button
...
Date.prototype.dateFormat = function(format)
{
	if(!format) { // the default date format to use - can be customized to the current locale
		//format = 'm/d/Y';
		//format = 'Y-m-d'; 
		//Rajarshi's customized date format
		format = 'd-M-y';
	}
